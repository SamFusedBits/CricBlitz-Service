...
//Make it as a service so that we can AutoAdd
@Service
public class MatchServiceImpl implements MatchService {
    ...
    //matchRepo.findAll() will return match history of all matches in our database
    @Override
...
//                update the match in database
    ...
    @Override
    public List<List<String>> getCWCPointTable() {
